...
export default function SignupPage() {
  ...
  return (
    <div className={`${inter.variable} ${jetbrainsMono.variable} font-sans min-h-screen bg-black text-white flex items-center justify-center`}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Join us to start exploring NFT analytics
          </p>
        </div>

        {/* Signup Form */}
        <div className="bg-white/10 rounded-2xl p-8 border border-gray-700 shadow-xl">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/login" className="text-white hover:text-gray-200 font-medium transition-colors duration-200">
                Sign in
              </Link>
            </p>
          </div>
