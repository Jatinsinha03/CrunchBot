...
export async function ownerHandler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const allowedSortBy = ["acquired_date", "quantity"];
    ...
    const data = await callBitscrunchGET("owner", query);
