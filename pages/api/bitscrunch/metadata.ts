...
export async function metadataHandler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Ignore sort_by if present
    const data = await callBitscrunchGET("metadata", query);
